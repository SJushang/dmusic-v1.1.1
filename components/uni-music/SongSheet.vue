<template>
    <View class='SongSheet item' @click="go" >
        ...
        <View class='playCount'>
            <Image style='position:relative;top:2rpx;width: 10Px;height:10Px;margin: 3Px 3Px 0 0;display:inline-block;' :src="require('../../static/gedan.jpg')" />
...
export default {
    ...
    methods: {
        go() {
            uni.navigateTo({
                url: `/pages/musiclibrary/musiclibrary?id=${this.Oid}`
            })
        }
    }
}
