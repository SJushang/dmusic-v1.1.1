...
//歌曲详情
const getSong = (data = {}) => new Api('/api/test/url', data);
//获取歌词
const getLyric = (data = {}) => new Api('/api/test/lyric', data);
//搜索
...
//获取榜单---1热歌榜,
const getHot = (data = {}) => new Api('/api/test/index', data);
